...
ST_DRIVERS ?= sdk/ST/stm32f4xx_library/stm32f4xx_hal_driver
ST_CMSIS ?= sdk/ST/stm32f4xx_library/cmsis_device_f4
CMSIS_5 ?= sdk/CMSIS_5
...
SRC_C += \
	...
	$(ST_DRIVERS)/Src/stm32f4xx_hal_rcc.c \
	$(ST_DRIVERS)/Src/stm32f4xx_hal_gpio.c \
	$(ST_DRIVERS)/Src/stm32f4xx_hal_flash.c \
	$(ST_DRIVERS)/Src/stm32f4xx_hal_flash_ex.c
